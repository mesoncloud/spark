...
object RuleIdCollection {
  ...
  private var rulesNeedingIds: Seq[String] = {
      ...
      "org.apache.spark.sql.catalyst.optimizer.AggregatePushdownThroughJoins" ::
      "org.apache.spark.sql.catalyst.optimizer.convertInnerToSemiJoins" ::
      "org.apache.spark.sql.catalyst.optimizer.EliminateInnerJoinWithAgg" ::
